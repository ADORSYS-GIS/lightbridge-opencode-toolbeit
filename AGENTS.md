...
- **One version line, one changelog entry.** All seventeen packages bump together; the bump PR also adds the `CHANGELOG.md` entry for that version. See [Releasing](#releasing) and [Changelog](#changelog).
